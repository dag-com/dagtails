# Beta tester email — PLACEHOLDER (not legal advice)
...
5. Tick that you have read the privacy notice, then enter the bar  
...
**Please**  
- Be 18 or older  
- Don’t forward the link as a public listing  
- Don’t share other testers’ emails  

If you want off the list, reply to this email.
...
*Counsel: this sits in `docs/legal/lawyer-review.zip` with the privacy placeholder.*
