...
export const INGREDIENTS = [
  ...
  { id: "red_bitter", name: "Red Bitter", unit: "ml", cat: "Liqueurs", color: "#b11226", mx: { fam: "amaro", abv: 25, sw: 0.35, so: 0, bi: 0.8, pot: 1.4 } },
  { id: "bitter_orange_aperitivo", name: "Bitter Orange Aperitivo", unit: "ml", cat: "Liqueurs", color: "#ff7a18", mx: { fam: "amaro", abv: 11, sw: 0.5, so: 0.05, bi: 0.55, pot: 1.3 } },
...
export const JUDGES = [
  ...
  },
  {
    ...
    likes: "Amaro, red bitter, stirred bitters, late-night digestifs",
  ...
  },
  {
    ...
    likes: "Prosecco, soda tops, spritzes, light bitter-sparkle builds",
...
export const RECIPE_ORIGINS = {
  ...
  garibaldi: { country: "Italy", flag: "🇮🇹", city: "Milan", era: "1980s", lore: "Red bitter and orange juice — a Milanese highball named for the patriot." },
  americano: { country: "Italy", flag: "🇮🇹", city: "Milan", era: "1860s", lore: "Red bitter, sweet vermouth, and soda — Milan's original aperitivo." },
  ...
  godfather: { country: "Italy", flag: "🇮🇹", city: "Milan", era: "1970s", lore: "Scotch and amaretto — a spirit-forward nightcap." },
  negroni: { country: "Italy", flag: "🇮🇹", city: "Florence", era: "1919", lore: "Equal parts gin, red bitter, and sweet vermouth — Count Negroni's order." },
  ...
  daiquiri: { country: "Cuba", flag: "🇨🇺", city: "Daiquirí", era: "1898", lore: "White rum, lime, and sugar — Cuba's shaken classic." },
  ...
  sidecar: { country: "France", flag: "🇫🇷", city: "Paris", era: "1920s", lore: "Cognac, orange liqueur, and lemon — a Prohibition-era coupe classic." },
  ...
  jamaican_mule: { country: "Jamaica", flag: "🇯🇲", city: "Kingston", era: "1940s", lore: "Rum, lime, and ginger beer — the rum buck, sibling to the Moscow Mule." },
  ...
  mai_tai: { country: "United States", flag: "🇺🇸", city: "Oakland", era: "1944", lore: "Two rums, orange liqueur, orgeat, and lime — \"mai tai\" means \"out of this world\" in Tahitian." },
  bahama_mama: { country: "Bahamas", flag: "🇧🇸", city: "Nassau", era: "1960s", lore: "Rum with pineapple, orange, and grenadine — a Bahamian beach-bar staple." },
  singapore_sling: { country: "Singapore", flag: "🇸🇬", city: "Singapore", era: "1915", lore: "Gin sling with cherry, citrus, and soda — Singapore, 1915." },
  ...
  pussyfoot: { country: "United Kingdom", flag: "🇬🇧", city: "London", era: "1920", lore: "Orange, lemon, lime, and grenadine — a 1920 London temperance cocktail." },
...
export const VENUES = [
  ...
  },
  {
    ...
    blurb: "Bitter-orange hour on a Milanese square.",
    mapPin: { x: 78, y: 20 },
    master: {
    ...
    drinkIds: ["garibaldi", "americano", "bellini", "kir_royale", "mimosa", "godfather", "negroni", "boulevardier"],
  },
  {
    id: "casa_cana", name: "Casa Caña", city: "Havana", country: "Cuba", flag: "🇨🇺",
    kind: "Rum bar", accent: "#e8c547", sign: "CASA CAÑA",
    bg: "assets/venues/casa_cana.png",
    interior: "assets/venues/interiors/casa_cana.png",
    hubBgSize: "170%", hubBgPos: "20% 70%", mascotFloor: "10%",
    blurb: "Mint, lime, and white rum in a Havana cane house.",
    mapPin: { x: 16, y: 48 },
    master: {
      name: "Constanza", title: "Cantinera of Casa Caña", emoji: "🌴",
  ...
  },
  {
    ...
    drinkIds: ["bloody_mary", "long_island", "whiskey_sour", "cosmopolitan", "old_fashioned", "manhattan", "sazerac", "mint_julep", "espresso_martini", "sidecar", "kamikaze", "lemon_drop_shot", "b52", "green_tea_shot"],
  },
  {
  ...
  },
  {
    ...
    drinkIds: ["jamaican_mule", "rob_roy", "rusty_nail", "penicillin"],
  },
  {
    ...
    drinkIds: ["amaretto_sour", "pisco_sour", "caipirinha", "mai_tai", "bahama_mama", "singapore_sling", "hurricane_cocktail", "pina_colada"],
  },
];
...
export const VENUES_UNDER = [
  ...
  },
  {
    ...
    drinkIds: ["virgin_pina_colada", "virgin_mojito", "pussyfoot", "tropical_cooler", "nojito_berry"],
  },
];
