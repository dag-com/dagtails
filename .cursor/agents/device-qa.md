...
5. **Hunt this class (blocker)** — full map: `docs/TEST-PLAN.md`
   ...
   - **Player-visual agreement:** tappable CTAs are not a UX pass. Result/COTD must not show two unlabeled grades (recipe % vs Crowd-pleaser vs /100). See gameplay-qa “UX critical thinking” and P23 in `docs/TEST-PLAN.md`
